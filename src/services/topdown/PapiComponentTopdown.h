#ifndef CALI_TOPDOWN_PAPI_COMPONENT_TOPDOWN_H
#define CALI_TOPDOWN_PAPI_COMPONENT_TOPDOWN_H
...
class PapiComponentTopdown : public TopdownCalculator
{
public:

    PapiComponentTopdown(IntelTopdownLevel level);

    virtual ~PapiComponentTopdown() = default;
...
#endif /* CALI_TOPDOWN_PAPI_COMPONENT_TOPDOWN_H */