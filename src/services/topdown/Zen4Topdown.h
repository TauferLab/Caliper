#ifndef CALI_TOPDOWN_ZEN4_TOPDOWN_H
#define CALI_TOPDOWN_ZEN4_TOPDOWN_H
...
class Zen4Topdown : public TopdownCalculator
{
public:

    Zen4Topdown(IntelTopdownLevel level);

    virtual ~Zen4Topdown() = default;
...
#endif /* CALI_TOPDOWN_ZEN4_TOPDOWN_H */